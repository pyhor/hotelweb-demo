    ...
    return (
        <Layout title="Ojingeo Hotel - Home" pageId="Ojingeo Hotel">
            ...
            <article>
                ...
                <Link href="/seoul-branch" id="seoul">Seoul 서울 &#9733;</Link>
                <Link href="/busan-branch" id="busan">Busan 부산 &#9733;</Link>
                <Link href="/gangnam-branch" id="gangman">Gangnam 강남 &#9733;</Link>
                <Link href="/mapo-gu-branch" id="mapogu">Mapo-gu 마포구 &#9733;</Link>
                <Link href="/incheon-branch" id="incheon">Incheon 인천 &#9733;</Link>
                <Link href="/gwangju-branch" id="gwangju">Gwangju 광주 &#9733;</Link>
